...
|*Recurrent Convolutional Network for Video-based Person Re-identification*|Paul Miller<br>Queen's University Belfast|CVPR 2016|利用CNN提取空间特征，RNN提取空间特征|CNN|RNN + average pooling|欧氏距离|Softmax Loss + Contrastive Loss|58|70|**Rank1** 40|
